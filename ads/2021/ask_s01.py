...
# Exercise 6.4.2 - Toivonen's algorithm
baskets_sample = [[1, 2, 3], [2, 3, 4], [3, 4, 5], [4, 5, 6]]
# The first pass is the same as Multistage
tv1 = Multistage(baskets_sample, 1)
tv1.run()
print(tv1.singletons_support)
print(tv1.pairs_support)
