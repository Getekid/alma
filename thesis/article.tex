...
We then investigate cases of fixed distribution functions, which create homogeneous behaviours for the users (making them pseudo-heterogeneous games), through which we then describe how flow, tolls and equilibria behave as that fixed value changes.
...
\begin{figure}
	...
	\begin{tikzpicture}[x=8cm, y=15cm, every node/.style={font=\small}]
		...
		\fill[black] (1/16,23/192) ellipse (0.005 and 0.0025) node[left=6,below] {$\frac{23}{192}$};
