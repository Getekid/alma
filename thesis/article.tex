...
In addition, each flow user responds to tolls in a heterogeneous way, i.e. each player $p$ in the flow has a different money-time sensitivity value, which is described by a distribution function $\alpha(p)$.
