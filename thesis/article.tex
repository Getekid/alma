...
All the above give us the graph for $\as$ in Figure \ref{figure:alpha_simple:split_example}.
\begin{figure}
	\centering
	\begin{tikzpicture}[x=5cm, y=2cm, every node/.style={font=\small}]
		...
		% Dots
		\fill[white] (0.5,4/3) ellipse (0.02 and 0.05);
		\draw[black] (0.5,4/3) ellipse (0.02 and 0.05);
		\fill[white] (0.5,5/3) ellipse (0.02 and 0.05);
		\draw[black] (0.5,5/3) ellipse (0.02 and 0.05);
	\end{tikzpicture}
...
Looking now at the relation between different fixed distribution functions, Lemma \ref{lemma:a_fixed_homogeneous} leads us to the following one.
\begin{lemma}
...
We now introduce the notion of profit within a flow interval.
